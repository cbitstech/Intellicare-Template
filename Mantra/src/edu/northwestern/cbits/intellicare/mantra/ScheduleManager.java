...
//		alarm.setInexactRepeating(AlarmManager.ELAPSED_REALTIME, 0, 60000, pi);
	...
	public void updateSchedule()
	{
    	...
    	int hour = prefs.getInt(ScheduleManager.REMINDER_START_HOUR, ScheduleManager.DEFAULT_HOUR);
        int minutes = prefs.getInt(ScheduleManager.REMINDER_START_MINUTE, ScheduleManager.DEFAULT_MINUTE);
