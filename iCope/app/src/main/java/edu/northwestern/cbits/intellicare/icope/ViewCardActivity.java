	...
	protected void onResume()
	{
		...
		if (intent.hasExtra(ViewCardActivity.REMINDER_ID))
		{
			...
			if (cursor.moveToNext())
			{
              ...
              /*      if (cardCursor.getString(cardCursor.getColumnIndex(CopeContentProvider.CARD_TYPE)).equals("one")){
                        card.setBackgroundResource(R.drawable.background_green);
                    }
                    else if  (cardCursor.getString(cardCursor.getColumnIndex(CopeContentProvider.CARD_TYPE)).equals("two")){
                        card.setBackgroundResource(R.drawable.background_yellow);
                    }
                    else if  (cardCursor.getString(cardCursor.getColumnIndex(CopeContentProvider.CARD_TYPE)).equals("three")) {
