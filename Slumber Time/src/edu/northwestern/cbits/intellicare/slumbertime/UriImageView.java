...
public class UriImageView extends ImageView 
{
	...
	public void setCachedImageUri(final Uri uri)
	{
		...
		final Uri imageUri = SlumberContentProvider.fetchCachedUri(this.getContext(), uri, new Runnable()
		{
			public void run() 
			{
				...
				activity.runOnUiThread(new Runnable()
				{
					public void run() 
					{
						Uri imageUri = SlumberContentProvider.fetchCachedUri(me.getContext(), uri, null);
